...
const translations = {
    fr: {
        ...
        'exp.sia.desc': '<li>Conception et développement d\'architectures RAG à grande échelle pour la gestion de connaissances en entreprise, incluant l\'ingestion de documents multi-formats et la recherche sémantique sur des millions d\'enregistrements.</li><li>Mise en place de pipelines RAG multimodaux intégrant texte, image et données tabulaires pour l\'extraction d\'informations et les requêtes inter-modales.</li><li>Développement et déploiement d\'API RESTful en production avec FastAPI et Pydantic, garantissant validation des données, versioning et gestion sécurisée via certificats Traefik.</li><li>Collaboration avec des équipes de conseil pluridisciplinaires pour transformer les besoins métier en solutions IA scalables pour des missions clients variées.</li>',
